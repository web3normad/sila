        ...
        <div className="bg-white dark:bg-[#2F2E34] border border-gray-200 dark:border-zinc-800 rounded-full">
          <div className="flex items-center gap-4 lg:gap-10 justify-between h-16 px-4 lg:px-10">
            ...
            <div className="hidden md:flex items-center gap-10 justify-end">
              ...
              <NavLink href="/features" label="Features" isActive={location.pathname === '/features'} />
              <NavLink href="/documentation" label="Documentation" isActive={location.pathname === '/documentation'} />
              <NavLink href="/open-source" label="Open Source" isActive={location.pathname === '/open-source'} />
